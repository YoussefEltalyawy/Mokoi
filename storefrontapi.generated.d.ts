...
export type RootHomeMetaobjectQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type RootHomeMetaobjectQuery = {
...
export type NewArrivalsProductFragment = Pick<
  StorefrontAPI.Product,
...
export type NewArrivalsProductsQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle' | 'createdAt'> & {
        priceRange: {
          minVariantPrice: Pick<
            StorefrontAPI.MoneyV2,
            'amount' | 'currencyCode'
...
export type CollectionForMenuFragment = Pick<
  StorefrontAPI.Collection,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query RootHomeMetaobject($handle: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    metaobject(handle: {type: "home_page", handle: $handle}) {\n      id\n      handle\n      fields { key type value }\n    }\n  }\n': {
    return: RootHomeMetaobjectQuery;
    variables: RootHomeMetaobjectQueryVariables;
  };
